...
class QLearningAgent(Agent):
    ...
    def __init__(self, env, n_states, n_actions, gamma, alpha, obs_to_state_id=lambda x: x,
    ...
    def learn(self, iterations):
        ...
        for i in range(iterations):
            ...
            next_state = self.obs_to_state_id(self.env.reset()) if done else self.obs_to_state_id(obs)
